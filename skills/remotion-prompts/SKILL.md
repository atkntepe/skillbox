...
3. Write a scene-by-scene storyboard.
   - Specify timestamps and frame counts at 30fps.
...
- When implementation code is requested, also use the Remotion best-practices skill and load the relevant Remotion rule files.
